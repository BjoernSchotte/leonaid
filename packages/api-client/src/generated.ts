...
export type AnalysisSnapshot = { readonly capabilityProfile: string; readonly createdAt: string; readonly filter: ResolvedAnalysisFilter; readonly id: string; readonly lastPageCounts: Array<LastPageCount>; readonly participationCount: number; readonly questions: Array<QuestionAggregate>; readonly rendererVersion: string; readonly statusCounts: ParticipationCounts; readonly surveyId: string; readonly versionNumber: number; };
export type AnalysisVersion = { readonly id: string; readonly number: number; readonly publishedAt: string; };
export type AnalysisVersions = { readonly items: Array<AnalysisVersion>; };
...
export type DeliveryContactRequest = { readonly name?: string | null; readonly phone?: string | null; };
...
export type InvoicePaymentDetailsResponse = { readonly accountHolder: string; readonly bic: string | null; readonly iban: string; };
...
export type InvoiceProfileResponse = { readonly confirmedAt: string | null; readonly issuer: InvoiceIssuerResponse; readonly legalConfigurationVersionId: string | null; readonly nextInvoiceNumber: string; readonly paymentDetails: InvoicePaymentDetailsResponse | null; readonly paymentTermsDays: number; readonly readyToIssue: boolean; readonly taxNote: string; readonly taxRateBasisPoints: number; readonly taxTreatment: "standard_vat" | "small_business" | "tax_exempt"; };
...
export type PrivacyErasureResponse = { readonly anonymizedCommitments: number; readonly caseId: string; readonly clearedActivityNotes: number; readonly clearedReminders: number; readonly completedAt: string; readonly openDecisions: Array<string>; readonly retainedDocumentIds: Array<string>; readonly retainedInvoiceIds: Array<string>; readonly retention: PrivacyRetentionResponse; readonly retentionReasons: Array<string>; readonly revokedConsents: number; readonly status: "completed_with_retention"; readonly subjectHash: string; };
export type PrivacyOrderDeliveryResponse = { readonly actionId: string; readonly commitmentId: string; readonly deliveryContact: DeliveryContactRequest | null; readonly deliveryWindowId: string | null; readonly deliveryWindowSnapshot: Record<string, string> | null; };
...
export type PrivacyRetentionResponse = { readonly auditDays: number; readonly commitmentDays: number; readonly consentEvidenceDays: number; readonly contactDays: number; readonly invoiceDays: number; readonly legalConfigurationVersion: number; readonly legalConfigurationVersionId: string; };
export type PrivacySubjectReportResponse = { readonly consents: Array<PrivacyConsentResponse>; readonly crmDeletionStatus: "pending_manual_review"; readonly found: boolean; readonly generatedAt: string; readonly openLegalDecisions: Array<string>; readonly orderDeliveries: Array<PrivacyOrderDeliveryResponse>; readonly references: Array<PrivacyReferenceResponse>; readonly retention: PrivacyRetentionResponse; readonly subjectEmail: string; readonly suppressions: Array<PrivacySuppressionResponse>; };
...
export type PublicActionRouteResponse = { readonly action: PublicCharityActionResponse | null; readonly availability: "published" | "inactive" | "archive"; readonly canonicalPath: string; readonly redirectPath?: string | null; readonly routeKind: "alias" | "archive"; readonly routePath: string; readonly routeValue: string; readonly submissionsAllowed: boolean; };
...
export type PublicOrderFormResponse = { readonly accessToken: string; readonly allowMessage: boolean; readonly deliveryConfiguration?: DeliveryConfigurationResponse | null; readonly formKey: string; readonly introduction: string; readonly legalBasis: string; readonly privacyContactEmail: string; readonly privacyNoticeText: string; readonly privacyNoticeVersion: string; readonly requireBillingAddress: boolean; readonly requireCompanyName: boolean; readonly requireContactName: boolean; readonly requireDeliveryAddress: boolean; readonly requireEmail: boolean; readonly requirePhone: boolean; readonly submitLabel: string; readonly title: string; };
...
export type PublicOrderQuantityResponse = { readonly piecesPerUnit: number | null; readonly quantity: number; readonly unit: "box" | "piece" | "package" | "sponsoring"; };
export type PublicOrderResultResponse = { readonly commitmentId: string; readonly crmOutcome: "created" | "reused"; readonly currency: string; readonly publicReference: string; readonly quantities: Array<PublicOrderQuantityResponse>; readonly replayed: boolean; readonly status: "review_ready"; readonly totalBoxes: number; readonly totalMinor: number; readonly totalPieces: number; };
export type QuestionAggregate = { readonly answered: number; readonly counts: Array<AggregateCount>; readonly hidden: number; readonly invalid: number; readonly kind: "text" | "comment" | "date" | "number" | "radiogroup" | "dropdown" | "checkbox" | "rating" | "matrix"; readonly matrixRows: Array<MatrixRowAggregate>; readonly maximum: number | null; readonly mean: number | null; readonly minimum: number | null; readonly nps: number | null; readonly questionId: string; readonly relevant: number; readonly sum: number | null; readonly title: string; readonly unanswered: number; };
...
export type ResponseChoice = { readonly label: string; readonly value: string | number | number | boolean | null; };
...
export type ResponseQuestion = { readonly choices: Array<ResponseChoice>; readonly id: string; readonly kind: string; readonly rows: Array<ResponseChoice>; readonly title: string; };
...
export class LeonAidApiClient {
  ...
  async changeMemberStatus(
    ...
    options: RequestOptions = {},
  ): Promise<MemberStatusChangeResponse> {
    return this.request<MemberStatusChangeResponse>(
      `/api/v1/admin/members/${encodeURIComponent(String(userId))}/status`,
      {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async getSurveySettings(
    options: RequestOptions = {},
  ): Promise<TimeoutSettingsResponse> {
    return this.request<TimeoutSettingsResponse>(
  ...
  async listSurveys(
    queryParameters: { readonly status?: "draft" | "active" | "ended" | "archived" | "deleted" | null; readonly search?: string; readonly offset?: number; } = {},
    options: RequestOptions = {},
    ...
    const queryString = searchParameters.toString();
    const requestPath = "/api/v1/surveys" + (queryString ? `?${queryString}` : "");
    return this.request<SurveyListResponse>(
      requestPath,
      { method: "GET" },
      options,
    );
  ...
  async updateSurveyAccess(
    ...
    return this.request<SurveySummaryResponse>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/access`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async createSurveyAnalysis(
    surveyId: string,
    body: CreateAnalysisSnapshot,
    options: RequestOptions = {},
  ): Promise<AnalysisSnapshot> {
    return this.request<AnalysisSnapshot>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/analysis`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async listSurveyAnalysisVersions(
    surveyId: string,
    options: RequestOptions = {},
  ): Promise<AnalysisVersions> {
    return this.request<AnalysisVersions>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/analysis/versions`,
      { method: "GET" },
      options,
    );
  }
  ...
  async getSurveyAnalysis(
    ...
    return this.request<AnalysisSnapshot>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/analysis/${encodeURIComponent(String(snapshotId))}`,
      { method: "GET" },
      options,
    );
  }

  async deleteSurveyPermanently(
    surveyId: string,
    body: Mutation,
    options: RequestOptions = {},
  ): Promise<SurveyDeletionResponse> {
    return this.request<SurveyDeletionResponse>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/delete-permanently`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async listSurveyInvitations(
    surveyId: string,
    queryParameters: { readonly offset?: number; } = {},
    options: RequestOptions = {},
  ): Promise<SurveyInvitationsResponse> {
    const searchParameters = new URLSearchParams();
    if (queryParameters.offset !== undefined && queryParameters.offset !== null) {
      searchParameters.set("offset", String(queryParameters.offset));
    }
    const queryString = searchParameters.toString();
    const requestPath = `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/invitations` + (queryString ? `?${queryString}` : "");
    return this.request<SurveyInvitationsResponse>(
      requestPath,
      { method: "GET" },
      options,
    );
  ...
  async createSurveyInvitation(
    surveyId: string,
    body: SurveyInvitationCreate,
    options: RequestOptions = {},
  ): Promise<SurveyInvitationResponse> {
    return this.request<SurveyInvitationResponse>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/invitations`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async revokeSurveyInvitation(
    ...
    return this.request<SurveyInvitationResponse>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/invitations/${encodeURIComponent(String(invitationId))}/revoke`,
      {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
  ...
  async updateSurveyTimeout(
    surveyId: string,
    body: SurveyTimeoutSettings,
    options: RequestOptions = {},
  ): Promise<SurveySummaryResponse> {
    return this.request<SurveySummaryResponse>(
      `/api/v1/surveys/${encodeURIComponent(String(surveyId))}/settings`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify(body),
