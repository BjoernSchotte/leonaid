...
export type AcquisitionActivityWorkItemResponse = { readonly assignmentId: string; readonly city: string | null; readonly dueAt: string | null; readonly email: string | null; readonly nextAction: string | null; readonly partyDisplayName: string; readonly partyId: string; readonly partyKind: "company" | "person"; readonly postalCode: string | null; readonly priority: number; readonly revision: number; readonly status: "open" | "contacted" | "committed" | "declined" | "handed_over"; readonly urgency: "overdue" | "today" | "upcoming" | "none"; };
