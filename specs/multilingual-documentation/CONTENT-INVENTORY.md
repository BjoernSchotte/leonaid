...
| -------- | ------- | ------------ | --------- | ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------------ | ----------------- |
| DOC-P001 | 01      | Orientierung | Erklärung | `index.mdx` · `/{locale}/`                                                                                          | `README.md`, `PERSONAS.md`, dieses Inventar                             | erstellt/erstellt       | Anwenderteil fachlich und sprachlich geprüft; technische Einstiege mit DOC-050 | DOC-040 + DOC-050 |
...
| DOC-P003 | 01      | Orientierung | Referenz  | `known-limits.md` · `/{locale}/known-limits/`                                                                       | `specs/leonaid-poc/KNOWN-LIMITS.md`, aktuelle Specs und Implementierung | erstellt/erstellt       | Anwendergrenzen fachlich und sprachlich geprüft; Betriebsgrenzen mit DOC-050   | DOC-040 + DOC-050 |
