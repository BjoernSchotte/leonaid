...
| DOC-P012 | 03 | Anwendung | How-to | `user/how-to/manage-delivery-windows.md` · `/{locale}/user/how-to/manage-delivery-windows/` | `packages/features/src/action-admin`, Lieferplan/-proofs | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P013 | 03 | Anwendung | How-to | `user/how-to/place-public-order.md` · `/{locale}/user/how-to/place-public-order/` | `apps/public`, `apps/campaign-site`, Public-Order-Tests | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P014 | 03 | Anwendung | How-to | `user/how-to/record-invoice-payment.md` · `/{locale}/user/how-to/record-invoice-payment/` | `packages/features/src/action-admin`, Invoice-Tests, `PERSONAS.md` | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P015 | 03 | Anwendung | How-to | `user/how-to/regain-access.md` · `/{locale}/user/how-to/regain-access/` | Auth-Komponenten, Session-/Invitation-Tests, Runbook | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P016 | 04 | Anwendung | Referenz | `user/reference/roles.md` · `/{locale}/user/reference/roles/` | `PERSONAS.md`, Identity-Domain und API | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P017 | 04 | Anwendung | Referenz | `user/reference/statuses-and-fields.md` · `/{locale}/user/reference/statuses-and-fields/` | Domain-Enums, API-Vertrag und UI-Labels | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P018 | 04 | Anwendung | Erklärung | `user/explanation/actions-contacts-orders.md` · `/{locale}/user/explanation/actions-contacts-orders/` | Produktarchitektur, Core/CRM-Adapter | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P019 | 04 | Anwendung | Erklärung | `user/explanation/action-permissions.md` · `/{locale}/user/explanation/action-permissions/` | `PERSONAS.md`, Policy- und Identity-Nachweise | geplant/geplant | Björn Schotte: offen/offen | DOC-040 |
| DOC-P020 | 01 | Betrieb | Erklärung | `ops/index.mdx` · `/{locale}/ops/` | Compose-, Pilot-, Backup- und Upgrade-README | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P021 | 05 | Betrieb | Tutorial | `ops/tutorials/local-demo.md` · `/{locale}/ops/tutorials/local-demo/` | `README.md`, `infra/compose/README.md`, `test-handoff` | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P022 | 05 | Betrieb | How-to | `ops/how-to/deploy-pilot.md` · `/{locale}/ops/how-to/deploy-pilot/` | `infra/pilot/README.md`, Release-Runbook | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P023 | 05 | Betrieb | How-to | `ops/how-to/backup-and-restore.md` · `/{locale}/ops/how-to/backup-and-restore/` | `infra/backup/README.md`, Pilot-Runbook | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P024 | 05 | Betrieb | How-to | `ops/how-to/upgrade-and-rollback.md` · `/{locale}/ops/how-to/upgrade-and-rollback/` | `infra/upgrade/README.md`, Pilot-Release-Runbook | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P025 | 05 | Betrieb | How-to | `ops/how-to/troubleshoot.md` · `/{locale}/ops/how-to/troubleshoot/` | Compose-/Pilot-Diagnose, Auth-/Mail-/TLS-Nachweise | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P026 | 06 | Betrieb | Referenz | `ops/reference/requirements-and-configuration.md` · `/{locale}/ops/reference/requirements-and-configuration/` | `./leonaid doctor`, `.env.example`, Pilot-Konfiguration | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P027 | 06 | Betrieb | Referenz | `ops/reference/services-ports-and-commands.md` · `/{locale}/ops/reference/services-ports-and-commands/` | `infra/compose/compose.yml`, `./leonaid help` | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P028 | 06 | Betrieb | Erklärung | `ops/explanation/system-boundaries.md` · `/{locale}/ops/explanation/system-boundaries/` | Architektur, Compose und Datenhoheit | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P029 | 06 | Betrieb | Erklärung | `ops/explanation/operations-model.md` · `/{locale}/ops/explanation/operations-model/` | Pilot-, Backup-, Upgrade- und Incident-Verträge | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P030 | 01 | Entwicklung | Erklärung | `dev/index.mdx` · `/{locale}/dev/` | Development Guide, Workspace und Architektur | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P031 | 07 | Entwicklung | Tutorial | `dev/tutorials/first-change.md` · `/{locale}/dev/tutorials/first-change/` | `specs/leonaid-poc/DEVELOPMENT.md`, `test-handoff` | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P032 | 07 | Entwicklung | How-to | `dev/how-to/update-api-contract.md` · `/{locale}/dev/how-to/update-api-contract/` | `tools/openapi`, API-Workflow, `generate-api-client` | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P033 | 07 | Entwicklung | How-to | `dev/how-to/debug.md` · `/{locale}/dev/how-to/debug/` | Development Guide, `./leonaid doctor`, Compose | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P034 | 07 | Entwicklung | How-to | `dev/how-to/add-migration.md` · `/{locale}/dev/how-to/add-migration/` | `migrations/README.md`, migration tests | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P035 | 08 | Entwicklung | Referenz | `dev/reference/api.md` · `/{locale}/dev/reference/api/` | `packages/api-client/openapi.json` via freigegebenem Generator | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P036 | 08 | Entwicklung | Referenz | `dev/reference/repository-and-commands.md` · `/{locale}/dev/reference/repository-and-commands/` | Root-Workspace, App-/Package-READMEs, `./leonaid help` | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
| DOC-P037 | 08 | Entwicklung | Erklärung | `dev/explanation/architecture-and-data-ownership.md` · `/{locale}/dev/explanation/architecture-and-data-ownership/` | Architektur, Produktvorschlag und Adapter | geplant/geplant | Björn Schotte: offen/offen | DOC-050 |
