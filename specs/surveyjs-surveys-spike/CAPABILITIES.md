...
| C-10 | `surveys-authoring.spec.mjs` unsafe presentation rejection and correction; editor title/hint/completion controls; `surveys-completion-message.spec.mjs` immutable completion text; scoped `styles.css` tokens | [Validated preview](proofs/SURV-040.md#complete-sample-authoring-and-validated-preview), [theme/restoration](proofs/SURV-020.md#browser-rendering-and-restoration-disposition), [report rendering](proofs/SURV-080.md#consolidated-render-acceptance). [Published completion text](proofs/SURV-050.md#published-completion-text); [bounded host logos](proofs/SURV-020.md#bounded-host-logo-integration) load in both actual hosts, survive respondent restoration and reject external/unsafe path forms |
