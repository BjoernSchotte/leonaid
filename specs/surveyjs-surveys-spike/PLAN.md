...
- [ ] **100.1** Wire the aggregate survey test command and CI lane, deterministic isolation/cleanup and failure artifact handling. Acceptance: **100.A1, 100.A2, 100.A3, 100.A5**.
  ...
  [CI output capture now preserves stream boundaries](proofs/SURV-100-CI-OUTPUT.md): real subprocess and scanner-wrapper proofs retain strict artifact rejection. Final branch CI remains open.
