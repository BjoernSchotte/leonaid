...
- [x] **090.2h** Resume a quarantined pilot restore after an interrupted erasure reapplication without importing the backup again. Bind a private authenticated phase receipt to configuration, source/target, repository, confirmed manifest and restored volumes; reject altered receipts, concurrent restores sharing the operator lock directory and application-started targets. Acceptance: **090.A3, interrupted pilot reapplication portion**. Integration: **090.S3f**. Prove committed revocations before interruption, preserved sentinel data across resume, repeatable cleanup and old-access denial before accepting this task. [Live evidence](proofs/SURV-090.md#interrupted-pilot-reapplication-and-authenticated-resume).
