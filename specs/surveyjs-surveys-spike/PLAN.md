...
- [x] **060.2b** Provide publication-only members a validated, revision-bound review and publish UI without design access; prove stale-review rejection, exact retry after a lost acknowledgement and local preview isolation. Acceptance: **060.A1/A4, publisher-only portion**. [Live evidence](proofs/SURV-060.md#publisher-only-review-and-publication). Full persona/state/browser acceptance remains open.
- [x] **060.2c** Prove active-survey controls, filtered lists and direct response links for 14 personas across four resource scopes on desktop/mobile. Acceptance: **060.A4, active-survey browser matrix portion**. [Live evidence](proofs/SURV-060.md#active-survey-browser-permission-matrix). Full state/invitation and mutation coverage remains open.
- [x] **060.2d** Prove successful design, publish/end, archive/unarchive and trash/restore/erasure handoffs between four single-capability members on standalone/action-linked surveys at desktop/mobile sizes. Acceptance: **060.A1/A4, lifecycle role journeys**. [Live evidence](proofs/SURV-060.md#separate-role-lifecycle-journeys). Remaining permission and invitation scope keeps parent acceptance open.
- [x] **060.2e** Recheck revoked grants, expired action memberships and suspended accounts using existing sessions; reject foreign snapshot, response, version and export-job IDs without changing survey state. Acceptance: **060.A1, dynamic authority and child-resource boundaries**. Integration: **060.S1b**. [Live evidence](proofs/SURV-060.md#changed-authority-and-child-resource-boundaries). Parent acceptance remains open for invitation/special-route scope and consolidated identity separation.
