...
- [ ] Gemeinsamer Aktionskontext sowie eigenständige Listen/Seiten mit explizitem berechtigtem Personenkreis. Verlinkung oder Erwähnung erweitert keine Rechte.
  - [x] Task-Listen aus der Oberfläche einer aktuell verwalteten Aktion zuordnen, Aktionskontext anzeigen und Listen nach bekannten Aktionen filtern. Echter Web-/PWA-Nachweis mit Charity-Admin und Aktionsmitglied bestanden. Globale Aktionsauswahl für System-Admins ohne eigene Aktionsmitgliedschaft sowie Wissens-/Materialkontexte bleiben offen.
