...
- [x] Durchgängiger Formatierungsvertrag und allgemeine Toolbar: Fett, Kursiv,
      ...
      Undo/Redo; große Schreibfläche. Haupt- und Auswahltoolbar bleiben auch in der
      PWA einzeilig; zusätzliche Steuerelemente öffnen sich in einem Menü.
      Backend validiert neue Attribute eng;
...
- [x] Gesamtabnahme: Desktop und mobile PWA, Auswahl per Maus/Tastatur,
