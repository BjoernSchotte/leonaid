...
| Same-action operational configuration propagation | Real Admin UI saves 3/3/1 windows; already-loaded Anna/public forms refresh to identical saved IDs without rebuild or CMS publication. Shared ordering/readback and EmDash continuation remain open. | Partial |
