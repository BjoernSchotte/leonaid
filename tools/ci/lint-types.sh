...
run_python uv run --frozen --no-sync ruff check \
  ...
  tools/invitations tools/invoices tools/matching tools/openapi tools/outbox tools/policy tools/storage \
  tools/public_actions tools/public_orders tools/pwa tools/schema tools/seed \
  tools/sessions tools/templates tools/testkit tools/twenty tools/typst packages/testkit
