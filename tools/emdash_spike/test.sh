...
case "$test_case" in
  krapfentaxi-source|krapfentaxi-migration|krapfentaxi-orders|alias-namespaces|alias-persistence|alias-commands|alias-http|redirect-aliases|recovery-sql|recovery-local) ;;
