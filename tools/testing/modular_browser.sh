...
docker run --rm --network "${project}_edge" \
  ...
  tests/e2e/modules-tasks.spec.mjs tests/e2e/tasks-details.spec.mjs tests/e2e/tasks-views.spec.mjs tests/e2e/tasks-planning.spec.mjs tests/e2e/tasks-ordering.spec.mjs tests/e2e/public-inbox-retry.spec.mjs \
